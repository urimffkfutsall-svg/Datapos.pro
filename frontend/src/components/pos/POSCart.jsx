...
export const POSCart = ({
  ...
  return (
    <Card className="flex-1 border-0 shadow-sm overflow-hidden">
      {/* Header */}
      <div className="bg-[#0E4B49]/10 px-4 py-2 border-b border-[#0E4B49]/20">
            ...
            {cart.length === 0 ? (
              ...
              cart.map((item, index) => {
                ...
                return (
                  <TableRow 
                    key={item.product_id} 
                    className={`table-row-hover cursor-pointer ${selectedItemIndex === index ? 'bg-[#0E4B49]/10' : ''}`}
                  ...
                  >
                    ...
                    <TableCell>
                      {canEdit ? (
                        ...
                        >
                          <SelectTrigger className="border-[#0E4B49]">
                    ...
                    <TableCell className="text-right">
                      {canEdit ? (
                        <Input
                          ...
                          className="w-20 h-7 text-right text-sm border-[#0E4B49]"
                          min="0"
                          step="0.01"
                        />
                      ) : (
                    ...
                    <TableCell className="text-center">
                      {canEdit ? (
                        <Input
                          ...
                          onClick={(e) => e.stopPropagation()}
                          className="w-16 h-7 text-center text-sm border-[#0E4B49]"
                          min="0"
                          max="100"
                        />
                      ) : (
