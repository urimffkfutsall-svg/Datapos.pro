...
export const POSActionButtons = ({
  ...
  return (
    <div className="w-full lg:w-48 flex flex-row lg:flex-col gap-2">
      ...
      <Button
        variant="outline"
        className={`flex-1 lg:h-14 flex items-center justify-center gap-2 ${customerName ? 'border-[#0E4B49] text-[#0E4B49]' : ''}`}
      ...
      >
        ...
        <span className="text-xs bg-emerald-100 px-1.5 py-0.5 rounded ml-1">F4</span>
      </Button>
      ...
      {canToggleVat && (
        <Button
          className={`flex-1 lg:h-14 flex items-center justify-center gap-2 ${applyNoVat ? 'bg-orange-500 hover:bg-orange-600' : 'bg-[#0E4B49] hover:bg-[#0A3634]'}`}
          onClick={onToggleVat}
