        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-2">
            <Button
              ...
              className={paymentMethod === 'cash' ? 'bg-[#0E4B49] hover:bg-[#0A3634]' : ''}
            ...
            <Button
              ...
              className={paymentMethod === 'bank' ? 'bg-[#0E4B49] hover:bg-[#0A3634]' : ''}
          ...
          {paymentMethod === 'cash' && (
            <>
              <div className="relative">
                <span className="absolute left-3 top-1/2 -translate-y-1/2 text-[#0E4B49] font-bold">€</span>
                <Input
                  ref={cashInputRef}
                  type="text"
                  value={cashAmount}
          ...
          {paymentMethod === 'bank' && (
            <div className="p-4 bg-gray-50 rounded-lg text-center">
              ...
              <p className="text-2xl font-bold text-[#0E4B49]">€{cartTotals.total.toFixed(2)}</p>
            </div>
          )}
          ...
          <div className="space-y-2">
            <div className="flex items-center gap-3 p-3 bg-gray-50 rounded-lg">
              <Checkbox
                ...
                className="border-[#0E4B49] data-[state=checked]:bg-[#0E4B49]"
            ...
            {printReceipt && (
              <div className="flex items-center gap-3 p-3 bg-emerald-50 rounded-lg border border-emerald-100">
                ...
                />
                <label htmlFor="directPrint" className="text-sm font-medium cursor-pointer flex-1 text-emerald-800">
