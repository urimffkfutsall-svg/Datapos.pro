        ...
        <div className="flex items-center justify-between flex-wrap gap-3">
          <div>
            <CardTitle className="flex items-center gap-2">
              <Ticket className="h-5 w-5 text-[#0E4B49]" />
              Kodet e zbritjes
            </CardTitle>
            <CardDescription>
          ...
          <Button onClick={openCreate} className="bg-[#0E4B49] hover:bg-[#0A3634] text-white">
        ...
        {loading ? (
          ...
          <Table>
            ...
            <TableBody>
              {coupons.map(c => (
                <TableRow key={c.id}>
                  <TableCell className="font-mono font-bold text-[#0E4B49]">{c.code}</TableCell>
      ...
      <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
        <DialogContent className="max-w-md">
          ...
          <DialogFooter>
            ...
            <Button onClick={handleSave} className="bg-[#0E4B49] hover:bg-[#0A3634] text-white">
