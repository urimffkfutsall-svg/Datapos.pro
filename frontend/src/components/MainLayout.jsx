      ...
      <header className="lg:hidden fixed top-0 left-0 right-0 z-50 bg-white border-b border-gray-200 px-4 py-3 shadow-sm">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            <div className="w-8 h-8 bg-[#0E4B49] rounded-lg flex items-center justify-center">
      ...
      >
        ...
        <div className="h-14 flex items-center gap-2.5 px-5 border-b border-white/10 flex-shrink-0">
          ...
          <div className="flex flex-col leading-tight">
            ...
            <span className="text-[9px] text-emerald-200 font-medium tracking-wider uppercase">POS System</span>
          </div>
        </div>
        ...
        <div className="px-5 py-5 border-b border-white/10 flex-shrink-0">
          <div className="flex flex-col items-center text-center">
            ...
            <p className="text-[11px] text-emerald-200 truncate max-w-full mt-0.5">
        ...
        <div className="p-3 border-t border-white/10 flex-shrink-0">
          <button
            ...
            className="w-full flex items-center gap-3 px-4 py-2.5 rounded-xl text-emerald-100 hover:bg-red-500/20 hover:text-white transition-all text-sm font-medium"
          >
          ...
          <div className="flex items-center gap-3">
            <div className="relative">
              ...
              <input
                type="text"
                placeholder="Kerko..."
                className="pl-9 pr-4 h-10 w-64 bg-gray-100 rounded-lg text-sm border-0 focus:ring-2 focus:ring-[#0E4B49] focus:bg-white outline-none transition-all"
              />
            </div>
            <button
