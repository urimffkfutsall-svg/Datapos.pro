                    ...
                    <TableRow key={user.id} className="table-row-hover">
                      <TableCell>
                        <div className="flex items-center gap-3">
                          <Avatar>
                            <AvatarFallback className="bg-[#0E4B49] text-white">
        ...
        <DialogContent>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <DialogFooter>
              ...
              <Button type="submit" className="bg-[#0E4B49] hover:bg-[#0A3634] rounded-xl shadow-md shadow-[#0E4B49]/20" data-testid="save-user-btn">
