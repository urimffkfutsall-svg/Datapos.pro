...
const AuditLogs = () => {
  ...
  const getActionBadge = (action) => {
    const colors = {
      ...
      create_sale: 'bg-[#0E4B49]/20 text-[#0E4B49]',
          ...
          <div className="flex flex-wrap gap-4">
            ...
            <div className="w-[200px]">
              <Select
                ...
                onValueChange={(value) => setFilters({ ...filters, entity_type: value === 'all' ? '' : value })}
              >
                ...
                {logs.map((log) => {
                  ...
                  return (
                    <TableRow key={log.id} className="table-row-hover">
                      ...
                      <TableCell>
                        <div className="flex items-center gap-2">
                          <div className="h-8 w-8 rounded-xl bg-[#0E4B49]/10 flex items-center justify-center">
                            <span className="text-sm font-medium text-[#0E4B49]">
