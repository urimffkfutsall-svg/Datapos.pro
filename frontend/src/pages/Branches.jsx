  ...
  return (
    <div className="space-y-6 animate-fade-in" data-testid="branches-page">
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        ...
        <Button
          className="bg-[#0E4B49] hover:bg-[#0A3634] gap-2 rounded-xl shadow-md shadow-[#0E4B49]/20"
          onClick={() => {
            resetForm();
            setShowDialog(true);
          }}
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        {loading ? (
          ...
          branches.map((branch) => (
            <Card key={branch.id} className="border border-gray-200/60 rounded-3xl shadow-sm bg-white/80 backdrop-blur-md hover-lift">
              <CardHeader className="pb-2">
                <div className="flex items-start justify-between">
                  <div className="flex items-center gap-3">
                    <div className="h-10 w-10 rounded-2xl bg-gradient-to-br from-[#0E4B49]/15 to-[#0E4B49]/5 flex items-center justify-center">
                      <Building2 className="h-5 w-5 text-[#0E4B49]" />
                    </div>
                    <div>
        ...
        <DialogContent>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <DialogFooter>
              ...
              <Button type="submit" className="bg-[#0E4B49] hover:bg-[#0A3634] rounded-xl shadow-md shadow-[#0E4B49]/20" data-testid="save-branch-btn">
