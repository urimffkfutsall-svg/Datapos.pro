...
const Reports = () => {
  ...
  const COLORS = ['#0E4B49', '#0E4B49', '#10B981', '#F59E0B', '#8B5CF6'];
            ...
            <>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-4 gap-4">
                <Card className="border border-gray-200/60 rounded-3xl shadow-sm bg-white/80 backdrop-blur-md">
                  <CardContent className="p-6">
                    ...
                    <p className="text-2xl font-bold text-[#0E4B49]">
              ...
              <Card className="border border-gray-200/60 rounded-3xl shadow-sm bg-white/80 backdrop-blur-md">
                ...
                <CardContent className="p-0">
                  <Table>
                    <TableHeader>
                      <TableRow className="bg-[#0E4B49]/8 hover:bg-[#0E4B49]/8 border-b border-[#0E4B49]/15">
          ...
          {loading ? (
            ...
            <>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                <Card className="border border-gray-200/60 rounded-2xl shadow-sm bg-gray-50/70">
                  <CardContent className="p-4">
                  ...
                  <div className="h-80">
                    <ResponsiveContainer width="100%" height="100%">
                      <BarChart data={profitReport.daily_breakdown}>
                        ...
                        />
                        <Bar dataKey="revenue" fill="#0F5A57" name="revenue" />
                  ...
                  <Table>
                    ...
                    <TableBody>
                      {profitReport.daily_breakdown.map((day) => (
                        <TableRow key={day.date} className="table-row-hover">
                          <TableCell>{format(new Date(day.date), 'dd MMMM yyyy', { locale: sq })}</TableCell>
                          <TableCell className="text-right text-emerald-600">€{day.revenue.toFixed(2)}</TableCell>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-4 gap-4">
                ...
                <Card className="border border-gray-200/60 rounded-3xl shadow-sm bg-white/80 backdrop-blur-md">
                  <CardContent className="p-6">
                    ...
                    <p className="text-2xl font-bold text-[#0E4B49]">{stockReport.summary.total_items}</p>
                  </CardContent>
                </Card>
                <Card className="border border-gray-200/60 rounded-3xl shadow-sm bg-white/80 backdrop-blur-md">
                  <CardContent className="p-6">
                    ...
                    <ResponsiveContainer width="100%" height="100%">
                      <BarChart data={cashierReport} layout="vertical">
                        ...
                        <Tooltip
                          ...
                          formatter={(value) => [`€${value.toFixed(2)}`, 'Shitjet']}
                        />
                        <Bar dataKey="total_sales" fill="#0E4B49" radius={[0, 4, 4, 0]} />
                      </BarChart>
                    </ResponsiveContainer>
                  </div>
                </CardContent>
                    ...
                    <TableBody>
                      {cashierReport.map((cashier, index) => (
                        <TableRow key={cashier.user_id} className="table-row-hover">
                          ...
                          <TableCell className="text-right font-bold text-[#0E4B49]">
