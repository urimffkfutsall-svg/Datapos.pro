    ...
    return (
      <div className="min-h-screen bg-[#0a1628] flex items-center justify-center p-4 relative overflow-hidden">
        ...
        <div className="absolute inset-0 overflow-hidden">
          <div className="absolute top-0 left-1/4 w-96 h-96 bg-[#0E4B49]/10 rounded-full blur-3xl"></div>
          <div className="absolute bottom-0 right-1/4 w-96 h-96 bg-[#0E4B49]/5 rounded-full blur-3xl"></div>
        </div>

        <div className="relative w-full max-w-md">
          <div className="bg-[#0f1f35]/80 backdrop-blur-xl rounded-2xl border border-white/10 shadow-2xl p-8 text-center">
            <div className="w-20 h-20 bg-[#0E4B49]/20 rounded-full flex items-center justify-center mx-auto mb-6">
              <CheckCircle className="w-10 h-10 text-[#0E4B49]" />
            </div>
            <h2 className="text-2xl font-bold text-white mb-4">Regjistrimi u Krye!</h2>
            <p className="text-gray-400 mb-4">
              Llogaria juaj u krijua me sukses. Keni <span className="text-[#0E4B49] font-semibold">30 ditë provë falas</span> për të testuar sistemin.
            </p>
            ...
            <div className="bg-[#0a1628] border border-white/10 rounded-xl p-4 mb-6 text-left">
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between bg-white/5 rounded-lg px-3 py-2">
                  ...
                  <span className="text-[#0E4B49] font-semibold">{formData.username}</span>
                </div>
                <div className="flex items-center justify-between bg-white/5 rounded-lg px-3 py-2">
            ...
            <div className="bg-[#0E4B49]/10 border border-[#0E4B49]/20 rounded-xl p-3 mb-6">
            ...
            <Button
              ...
              className="w-full h-12 bg-[#0E4B49] hover:bg-[#0A3634] text-white font-semibold rounded-xl"
            >
              Kyçu Tani
            </Button>
          </div>
    ...
    <div className="min-h-screen bg-[#0a1628] flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="relative w-full max-w-lg">
        ...
        <div className="bg-[#0f1f35]/80 backdrop-blur-xl rounded-2xl border border-white/10 shadow-2xl overflow-hidden">
          {/* Header */}
          <div className="bg-gradient-to-r from-[#0E4B49]/20 to-transparent p-6 border-b border-white/10">
          ...
          {/* Trial Benefits */}
          <div className="grid grid-cols-3 gap-3 p-4 bg-[#0E4B49]/5 border-b border-white/10">
            <div className="flex items-center gap-2 text-center">
              <Gift className="w-4 h-4 text-[#0E4B49]" />
              <span className="text-xs text-gray-300">30 Ditë Falas</span>
            </div>
            <div className="flex items-center gap-2 text-center">
              <Shield className="w-4 h-4 text-[#0E4B49]" />
              <span className="text-xs text-gray-300">Pa Kartë Krediti</span>
            </div>
            <div className="flex items-center gap-2 text-center">
              <Clock className="w-4 h-4 text-[#0E4B49]" />
          ...
          <form onSubmit={handleSubmit} className="p-6 space-y-4">
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  className={`pl-12 h-12 bg-white/5 border-white/10 text-white placeholder:text-gray-500 rounded-xl focus:border-[#0E4B49] focus:ring-[#0E4B49]/20 ${errors.company_name ? 'border-red-500' : ''}`}
                />
              </div>
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  onChange={handleChange}
                  className={`pl-12 h-12 bg-white/5 border-white/10 text-white placeholder:text-gray-500 rounded-xl focus:border-[#0E4B49] focus:ring-[#0E4B49]/20 ${errors.full_name ? 'border-red-500' : ''}`}
                />
              </div>
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  onChange={handleChange}
                  className={`pl-12 h-12 bg-white/5 border-white/10 text-white placeholder:text-gray-500 rounded-xl focus:border-[#0E4B49] focus:ring-[#0E4B49]/20 ${errors.username ? 'border-red-500' : ''}`}
                />
              </div>
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  onChange={handleChange}
                  className={`pl-12 h-12 bg-white/5 border-white/10 text-white placeholder:text-gray-500 rounded-xl focus:border-[#0E4B49] focus:ring-[#0E4B49]/20 ${errors.email ? 'border-red-500' : ''}`}
                />
              </div>
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  onChange={handleChange}
                  className={`pl-12 h-12 bg-white/5 border-white/10 text-white placeholder:text-gray-500 rounded-xl focus:border-[#0E4B49] focus:ring-[#0E4B49]/20 ${errors.phone ? 'border-red-500' : ''}`}
                />
              </div>
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  onChange={handleChange}
                  className={`pl-12 pr-12 h-12 bg-white/5 border-white/10 text-white placeholder:text-gray-500 rounded-xl focus:border-[#0E4B49] focus:ring-[#0E4B49]/20 ${errors.password ? 'border-red-500' : ''}`}
                />
                <button
                  type="button"
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  onChange={handleChange}
                  className={`pl-12 h-12 bg-white/5 border-white/10 text-white placeholder:text-gray-500 rounded-xl focus:border-[#0E4B49] focus:ring-[#0E4B49]/20 ${errors.confirmPassword ? 'border-red-500' : ''}`}
                />
              </div>
            ...
            <Button
              type="submit"
              disabled={loading}
              className="w-full h-12 bg-[#0E4B49] hover:bg-[#0A3634] text-white font-semibold rounded-xl transition-all duration-200 mt-6"
            >
              {loading ? (
            ...
            <div className="text-center pt-4 border-t border-white/10">
              <p className="text-gray-400 text-sm">
                Keni tashmë llogari?{' '}
                <Link to="/login" className="text-[#0E4B49] hover:text-[#00c9b7] font-medium">
                  Kyçuni këtu
                </Link>
              </p>
            </div>
