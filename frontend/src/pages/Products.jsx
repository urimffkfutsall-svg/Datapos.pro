    ...
    <div className="space-y-6 animate-fade-in" data-testid="products-page">
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        ...
        <div className="flex gap-2">
          ...
          />
          <Button
            className="bg-[#0E4B49] hover:bg-[#0A3634] gap-2"
            onClick={() => {
              resetForm();
              setShowDialog(true);
            }}
                      ...
                      <TableCell className="font-medium">
                        <div className="flex items-center gap-2">
                          ...
                          {product.metadata?.is_package && (
                            <Badge className="bg-[#0E4B49]/10 text-[#0E4B49] text-xs">Pako</Badge>
                          )}
                        </div>
                      </TableCell>
              ...
              <div className="space-y-3 md:col-span-2 rounded-2xl border border-gray-200 bg-gray-50/70 p-4">
                <label className="flex items-center gap-3 cursor-pointer">
                  <input
                    ...
                    className="h-4 w-4 accent-[#0E4B49]"
                  />
                  <span className="flex items-center gap-2 text-sm font-medium text-gray-800">
                    <Boxes className="h-4 w-4 text-[#0E4B49]" />
                ...
                {formData.is_package && (
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-1">
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="flex items-center rounded-xl bg-[#0E4B49]/10 border border-[#0E4B49]/20 px-4 h-10">
                        <span className="text-lg font-bold text-[#0E4B49]">€{formData.package_price || '0.00'}</span>
                      </div>
                    </div>
      ...
      <Button type="button" onClick={() => handleStockAdjust('out')} disabled={stockAdjustLoading} className="bg-red-500 hover:bg-red-600 text-white rounded-xl flex-1">
        − Hiq nga stoku
            ...
            <DialogFooter>
              ...
              <Button type="submit" className="bg-[#0E4B49] hover:bg-[#0A3634] rounded-xl shadow-md shadow-[#0E4B49]/20" data-testid="save-product-btn">
