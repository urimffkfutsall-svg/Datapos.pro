$target = "C:/Users/urim5/Desktop/datapos12-main/frontend/src/components/MainLayout.jsx"
$utf8 = New-Object System.Text.UTF8Encoding $false

if (Test-Path $target) {
  Copy-Item $target "$target.backup" -Force
  Write-Host "Backup u krijua: MainLayout.jsx.backup" -ForegroundColor Yellow
}
...
Write-Host "OK: MainLayout.jsx u ridizajnua!" -ForegroundColor Green

if (Select-String -Path $target -Pattern "bg-mesh-subtle" -SimpleMatch -Quiet) {
  Write-Host "Verifikim: OK - layout-i i ri eshte ne vend" -ForegroundColor Green
} else {
