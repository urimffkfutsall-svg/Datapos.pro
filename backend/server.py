...
from routers.shipping import router as shipping_router, shipments_router
from routers.shipping_public import router as shipping_public_router
from routers.shipping_webhooks import router as shipping_webhooks_router
...
# Shipping / Posta module
app.include_router(shipping_router, prefix="/api")
app.include_router(shipments_router, prefix="/api")
app.include_router(shipping_public_router, prefix="/api")
app.include_router(shipping_webhooks_router, prefix="/api")
